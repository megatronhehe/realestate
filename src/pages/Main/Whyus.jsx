...
const Whyus = () => {
	return (
		<section className="flex justify-center mt-20 text-white bg-gradient-to-r from-orange-400 to-orange-200">
			<div className="flex flex-col justify-between w-full max-w-4xl gap-6 p-6 font-semibold">
				...
				<ul className="flex flex-col gap-4 text-gray-600 sm:flex-row">
					<li className="flex flex-col items-center justify-center gap-2 p-4 bg-white sm:w-1/3 rounded-xl">
						<FaScaleBalanced className="w-12 h-12 p-2 text-white bg-green-300 rounded-full" />
						<h2>Legal</h2>
					...
					<li className="flex flex-col items-center justify-center gap-2 p-4 bg-white sm:w-1/3 rounded-xl">
						<FaRegHandshake className="w-12 h-12 p-2 text-white bg-blue-300 rounded-full" />
						<h2>Peer to peer</h2>
						<p className="text-sm text-center font-extralight">
							We operate within the bounds of the law, adhering to all relevant
							regulations and guidelines.
					...
					<li className="flex flex-col items-center justify-center gap-2 p-4 bg-white sm:w-1/3 rounded-xl">
						<FaHeart className="w-12 h-12 p-2 text-white bg-red-400 rounded-full" />
						<h2>Trusted</h2>
						<p className="text-sm text-center font-extralight">
